...
function GetStart(){
    return(
        <section className="containers getready-section !mt-[100px] !mb-[100px]">
            <div className="flex">
                <div className="mt-[120px] flex flex-col gap-[12px]">
                    ...
                    <Buttons extraClass="bg-[#FF774C] w-[274px] h-[69px] font-normal text-white text-[18px] mt-[18px]" title={"Get Start Now"}/>
                </div>
                <div className="mt-[39px]">
                    <img src={GetReadyImg} alt="Hero Img" width={1075} height={463}/>
                </div>
            </div>
        </section>
    )
