    ...
    return(
        <section className="bg-[#2A2C32] pt-[120px] pb-[110px]">
            <div className="containers">
                <div data-aos="zoom-out-down" className="flex flex-col gap-[10px] text-center mb-[60px]">
                ...
                <div className="flex gap-[30px]">
                    <div data-aos="zoom-out-right" className="flex flex-col gap-[39px]">
                    ...
                    <div data-aos="zoom-out-left" className="flex flex-col gap-[39px]">
                ...
                <div data-aos="fade-up" data-aos-duration="3000" className="mt-[86px] flex flex-col gap-[39px] w-[645px]">
