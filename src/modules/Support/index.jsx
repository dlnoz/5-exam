    ...
    return(
        <section className="containers">
            <div className="mt-[120px] mb-[110px] text-center">
                <div data-aos="zoom-in-up" className="flex flex-col gap-[10px] mb-[60px]">
                ...
                <div className="flex gap-[30px] mb-[86px]">
                    ...
                    <div  data-aos="zoom-in-left" className="flex flex-col gap-[39px]">
                ...
                <div className="flex gap-[30px]">
                    <div data-aos="zoom-out-up" className="flex flex-col gap-[39px]">
